...
import { BiBullseye, BiRocket, BiHeart, BiTime } from "react-icons/bi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-yellow-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-pink-400 to-yellow-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiBullseye className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're working on an Ads Manager feature to help you create, manage,
          and analyze your ads. Stay tuned for more advertising tools! 🎯
        </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-pink-50 border border-blue-200/50 rounded-xl p-4 transform hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-center space-x-3">
        ...
        <div className="bg-gradient-to-r from-pink-100 via-yellow-100 to-blue-100 rounded-xl p-5 mb-8 border border-pink-200/50">
          ...
          <p className="text-pink-700">
            Why not check out trending posts and reels? More advertising
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-pink-400 to-yellow-400 h-2 rounded-full w-1/24 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
          <div className="flex items-center justify-center space-x-2 mb-3">
            <div className="w-3 h-3 bg-gradient-to-r from-pink-400 to-yellow-400 rounded-full animate-bounce"></div>
            <div
              className="w-3 h-3 bg-gradient-to-r from-pink-400 to-yellow-400 rounded-full animate-bounce"
