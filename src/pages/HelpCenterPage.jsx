...
import { BiHelpCircle, BiRocket, BiHeart, BiTime } from "react-icons/bi";
      ...
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-400 to-yellow-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiHelpCircle className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
          <AiFillStar className="absolute top-0 right-8 w-6 h-6 text-yellow-400 animate-pulse" />
          <AiFillStar className="absolute bottom-2 left-6 w-4 h-4 text-purple-400 animate-bounce" />
        </div>
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're working on a Help Center to assist you with all your questions
          and issues. Stay tuned for more support options! 🆘
        </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200/50 rounded-xl p-4 transform hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-center space-x-3">
        ...
        <div className="bg-gradient-to-r from-blue-100 via-yellow-100 to-purple-100 rounded-xl p-5 mb-8 border border-blue-200/50">
          ...
          <p className="text-blue-700">
            Why not check out trending posts and reels? More help options are
            coming soon!
          </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-blue-400 to-yellow-400 h-2 rounded-full w-1/32 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
