...
import { BiUserPlus, BiRocket, BiHeart, BiTime } from "react-icons/bi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-pink-50 to-green-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-400 to-pink-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiUserPlus className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        {/* Title with Gradient */}
        <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-pink-600 bg-clip-text text-transparent mb-4">
          Connections Coming Soon!
        </h1>

        {/* Subtitle */}
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're building a new Connections feature to help you grow your network
          and interact with more people. Stay tuned for more ways to connect! 🤝
        </p>
        ...
        <div className="bg-gradient-to-r from-blue-100 via-pink-100 to-green-100 rounded-xl p-5 mb-8 border border-blue-200/50">
          ...
          <p className="text-blue-700">
            Why not check out trending posts and explore new communities? More
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-blue-400 to-pink-400 h-2 rounded-full w-1/8 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
          <div className="flex items-center justify-center space-x-2 mb-3">
            <div className="w-3 h-3 bg-gradient-to-r from-blue-400 to-pink-400 rounded-full animate-bounce"></div>
            <div
              className="w-3 h-3 bg-gradient-to-r from-blue-400 to-pink-400 rounded-full animate-bounce"
          ...
          <p className="text-xs text-gray-400 mt-1">1% Complete</p>
        </div>
      </div>
    </div>
  );
