...
import { BiInfoCircle, BiRocket, BiHeart, BiTime } from "react-icons/bi";
      ...
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-400 to-green-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiInfoCircle className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're working on an About page to share more about our platform and
          team. Stay tuned for more information! ℹ️
        </p>
        ...
        <div className="bg-gradient-to-r from-blue-100 via-green-100 to-yellow-100 rounded-xl p-5 mb-8 border border-blue-200/50">
          ...
          <p className="text-blue-700">
            Why not check out trending posts and reels? More about us is coming
            soon!
          </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-blue-400 to-green-400 h-2 rounded-full w-1/36 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
