...
import { BiBarChartAlt2, BiRocket, BiHeart, BiTime } from "react-icons/bi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-green-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiBarChartAlt2 className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're working on an Analytics feature to help you track and understand
          your performance. Stay tuned for powerful insights! 📊
        </p>
        ...
        <div className="bg-gradient-to-r from-blue-100 via-purple-100 to-green-100 rounded-xl p-5 mb-8 border border-blue-200/50">
          ...
          <p className="text-blue-700">
            Why not check out trending posts and reels? More analytics features
            are coming soon!
          </p>
          <div className="flex items-center justify-center mt-3 space-x-2">
            <BiHeart className="w-5 h-5 text-purple-500 animate-pulse" />
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-blue-400 to-purple-400 h-2 rounded-full w-1/20 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
