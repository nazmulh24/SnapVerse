...
import { BiDollarCircle, BiRocket, BiHeart, BiTime } from "react-icons/bi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-green-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-yellow-400 to-green-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiDollarCircle className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-yellow-400 to-green-400 h-2 rounded-full w-1/10 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
