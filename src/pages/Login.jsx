...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 px-3 sm:px-4 py-8 sm:py-12 relative overflow-x-hidden">
      ...
      <div className="flex items-start sm:items-center justify-center min-h-full">
        <div className="w-full max-w-sm sm:max-w-md relative mt-4 mb-16 sm:mt-0 sm:mb-0">
