    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiMessageSquareDetail className="w-12 h-12 text-white" />
          </div>
          {/* Floating sparkles */}
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're crafting an amazing messaging experience just for you. Stay
          tuned for something extraordinary! ✨
        </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200/50 rounded-xl p-4 transform hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-center space-x-3">
        ...
        <div className="bg-gradient-to-r from-purple-100 via-pink-100 to-indigo-100 rounded-xl p-5 mb-8 border border-purple-200/50">
          ...
          <p className="text-purple-700">
            Why not explore the amazing posts in your feed? There's so much
