...
import { BiVideo, BiRocket, BiHeart, BiTime } from "react-icons/bi";
...
const CreatorStudioPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiVideo className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're working on a Creator Studio to help you manage and analyze your
          content. Stay tuned for powerful creator tools! 🎬
        </p>
        ...
        <div className="bg-gradient-to-r from-purple-100 via-blue-100 to-yellow-100 rounded-xl p-5 mb-8 border border-purple-200/50">
          ...
          <p className="text-purple-700">
            Why not check out trending posts and reels? More creator tools are
            coming soon!
          </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-purple-400 to-blue-400 h-2 rounded-full w-1/18 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
