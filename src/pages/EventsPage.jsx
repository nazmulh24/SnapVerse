...
import { BiCalendarEvent, BiRocket, BiHeart, BiTime } from "react-icons/bi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-orange-400 to-pink-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiCalendarEvent className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
          <AiFillStar className="absolute top-0 right-8 w-6 h-6 text-yellow-400 animate-pulse" />
          <AiFillStar className="absolute bottom-2 left-6 w-4 h-4 text-orange-400 animate-bounce" />
        </div>
        ...
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're preparing an awesome Events feature for you. Stay tuned to join
          and discover amazing events! 🎉
        </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-orange-50 border border-blue-200/50 rounded-xl p-4 transform hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-center space-x-3">
        ...
        <div className="bg-gradient-to-r from-orange-100 via-pink-100 to-blue-100 rounded-xl p-5 mb-8 border border-orange-200/50">
          <div className="flex items-center justify-center mb-2">
            <HiOutlineEmojiHappy className="w-6 h-6 text-orange-600 mr-2" />
            <span className="font-bold text-orange-700 text-lg">
              Meanwhile...
            </span>
          </div>
          <p className="text-orange-700">
            Why not check out trending posts and upcoming reels? More events are
            coming soon!
          </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-orange-400 to-pink-400 h-2 rounded-full w-1/3 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
          <div className="flex items-center justify-center space-x-2 mb-3">
            <div className="w-3 h-3 bg-gradient-to-r from-orange-400 to-pink-400 rounded-full animate-bounce"></div>
            <div
              className="w-3 h-3 bg-gradient-to-r from-orange-400 to-pink-400 rounded-full animate-bounce"
