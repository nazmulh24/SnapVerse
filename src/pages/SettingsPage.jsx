...
import { BiCog, BiRocket, BiHeart, BiTime } from "react-icons/bi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-green-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-r from-gray-400 to-blue-400 rounded-full flex items-center justify-center mx-auto shadow-lg transform hover:scale-110 transition-transform duration-300">
            <BiCog className="w-12 h-12 text-white" />
          </div>
          {/* Floating stars */}
        ...
        {/* Title with Gradient */}
        <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-600 to-blue-600 bg-clip-text text-transparent mb-4">
          Settings Coming Soon!
        </h1>

        {/* Subtitle */}
        <p className="text-gray-600 mb-8 leading-relaxed text-lg">
          We're working on a Settings feature to help you personalize your
          experience. Stay tuned for more customization options! ⚙️
        </p>
        ...
        <div className="bg-gradient-to-r from-gray-100 via-blue-100 to-green-100 rounded-xl p-5 mb-8 border border-gray-200/50">
          <div className="flex items-center justify-center mb-2">
            <HiOutlineEmojiHappy className="w-6 h-6 text-gray-600 mr-2" />
            <span className="font-bold text-gray-700 text-lg">
              Meanwhile...
            </span>
          </div>
          <p className="text-gray-700">
            Why not check out trending posts and reels? More settings options
            are coming soon!
          </p>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
            <div className="bg-gradient-to-r from-gray-400 to-blue-400 h-2 rounded-full w-1/26 animate-pulse"></div>
          </div>
          {/* Animated Dots */}
          <div className="flex items-center justify-center space-x-2 mb-3">
            <div className="w-3 h-3 bg-gradient-to-r from-gray-400 to-blue-400 rounded-full animate-bounce"></div>
            <div
              className="w-3 h-3 bg-gradient-to-r from-gray-400 to-blue-400 rounded-full animate-bounce"
