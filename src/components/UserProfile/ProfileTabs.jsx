      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex-1 px-3 sm:px-3 lg:px-6 py-3 sm:py-4 text-center font-medium transition-colors flex items-center justify-center space-x-1.5 sm:space-x-2 min-h-[48px] ${
              activeTab === tab.id
